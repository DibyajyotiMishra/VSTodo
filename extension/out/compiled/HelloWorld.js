var app = (function () {
    ...
    /* user-interface/components/HelloWorld.svelte generated by Svelte v3.38.2 */

    const file = "user-interface/components/HelloWorld.svelte";
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h1 = element("h1");
    			h1.textContent = "Hello to all from Svelte";
