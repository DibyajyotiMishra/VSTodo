var app = (function () {
    ...
    /* user-interface/components/Sidebar.svelte generated by Svelte v3.38.2 */

    const { console: console_1 } = globals;
    const file = "user-interface/components/Sidebar.svelte";
    ...
    // (29:2) {#each todos as todo (todo.text)}
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			t0 = text(t0_value);
    			t1 = space();
    			attr_dev(li, "class", "svelte-cjso5i");
    			toggle_class(li, "complete", /*todo*/ ctx[7].completed);
    			add_location(li, file, 29, 4, 693);
    			this.first = li;
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(29:2) {#each todos as todo (todo.text)}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			button0.textContent = "Click for Info Message";
    			t3 = space();
    			button1 = element("button");
    			button1.textContent = "Click for Error Message";
    			attr_dev(input, "type", "text");
    			add_location(input, file, 23, 4, 590);
    			add_location(form, file, 17, 2, 460);
    			attr_dev(div, "class", "svelte-cjso5i");
    			add_location(div, file, 16, 0, 452);
    			add_location(ul, file, 27, 0, 648);
    			add_location(button0, file, 40, 0, 861);
    			add_location(button1, file, 51, 0, 1023);
    		},
